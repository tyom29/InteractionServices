#pragma checksum "C:\Users\artyom.yeprikyan\Desktop\FINCA Projects\InteractionServices\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c7f8afa2cf87fb8866bde81a3cb175c2684f850c"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c7f8afa2cf87fb8866bde81a3cb175c2684f850c", @"/Views/Home/Index.cshtml")]
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\artyom.yeprikyan\Desktop\FINCA Projects\InteractionServices\Views\Home\Index.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral(@"<script src=""https://cdnjs.cloudflare.com/ajax/libs/three.js/r70/three.min.js""></script>
...
<style>
    ...
    #credits {
        ...
        color: #b297a");
            WriteLiteral("2;\r\n        font-size: 0.7em;\r\n        text-transform: uppercase;\r\n        text-align: center;\r\n    }\r\n\r\n        #credits a {\r\n            color: #b297a2;\r\n        }\r\n\r\n        #credits .society6 {\r\n            color: #993f4c;\r\n        }\r\n</style>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c7f8afa2cf87fb8866bde81a3cb175c2684f850c4085", async() => {
                WriteLiteral("\r\n    <div id=\"world\">\r\n        <h2>Keep Calm,This API IS WORKING!</h2>\r\n    </div>\r\n    <div id=\"instructions\">Press and drag to make wind<br /><span class=\"lightInstructions\">our Developer Lion will surely appreciate</span></div>\r\n\r\n");
            }
            );
...
<script>
    ...
    function init() {
        ...
        camera.position.y = 0;
     ");
            WriteLiteral(@"   camera.lookAt(new THREE.Vector3(0, 0, 0));
        ...
        /*
        controls = new THREE.OrbitControls( camera, renderer.domE");
            WriteLiteral(@"lement);
        //*/
    }
    ...
    function handleTouchMove(event) {
       ");
            WriteLiteral(@" if (event.touches.length == 1) {
            event.preventDefault();
            mousePos = { x: event.touches[0].pageX, y: event.touches[0].pageY };
            isBlowing = true;
        }
...
");
            WriteLiteral(@"        propGeom.applyMatrix(new THREE.Matrix4().makeTranslation(0, 25, 0));
    ...
    Lion = function () {
      ...
      ");
            WriteLiteral(@"  this.redMat = new THREE.MeshLambertMaterial({
            color: 0xad3525,
            shading: THREE.FlatShading
        });
        ...
        var faceGeom = new THREE.BoxGeometry(80, 80,");
            WriteLiteral(@" 80);
        ...
        this.backRightFoot = ne");
            WriteLiteral(@"w THREE.Mesh(footGeom, this.yellowMat);
        ...
        for (var j = 0; j < 4; j++) {
            for (var k = 0; k < 4; k++) {
                ...
                var amp;
                var zOffset;
                var periodOffset = Math");
            WriteLiteral(@".random() * Math.PI * 2;
        ...
        // face
      ");
            WriteLiteral(@"  this.face = new THREE.Mesh(faceGeom, this.yellowMat);
        ...
        this.mustache6 = new THREE.Mesh(mustacheGeom, this.blackM");
            WriteLiteral(@"at);
    ...
    ");
            WriteLiteral(@"    this.spot6 = this.spot2.clone();
        ...
        // nose
        this.nose = new THREE.Mesh(noseGeom, thi");
            WriteLiteral(@"s.greyMat);
    ...
    Lion.prototype.updateBody = function (speed) {
        ...
        this.head.position.x += (this.tHeadPosX - this.head.positi");
            WriteLiteral(@"on.x) / speed;
        ...
        this.rightKnee.rotation.z += (this.tRight");
            WriteLiteral(@"KneeRotZ - this.rightKnee.rotation.z) / speed;
   ...
   ");
            WriteLiteral(@"     this.tHeadPosY = rule3(yTarget, -140, 260, 20, 100);
        this.tHeadPosZ = 0;
    ...
    Lion.prototype.cool = function (xTarget, yTarget) {
        ...
        this.tIrisPosY = 20;
   ");
            WriteLiteral(@"     this.tLeftIrisPosZ = 120;
        ...
        for (var i = 0; i < this.maneParts.length; i++) {
   ");
            WriteLiteral(@"         var m = this.maneParts[i].mesh;
        ...
        this.body.geometry.verticesNeedUpdat");
            WriteLiteral(@"e = true;
    }
